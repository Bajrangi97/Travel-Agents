...
#GROQ_API = st.secrets["GROQ_API_KEY"] # GROQ_API_KEY
GROQ_API = os.getenv("GROQ_API_KEY") # GROQ_API_KEY 
GROQ_API = os.getenv("GROQ_API_KEY")  # Ensure this matches the key in your .env file
if not GROQ_API:
...
class TravelAgents:
    def __init__(self):
        ...
        self.llm = ChatGroq(
            api_key=GROQ_API,
            model="groq/llama-3.3-70b-versatile" # llama-3.1-70b-versatile,
        )
